...
# load the temperature, specific humidiy, and specific cloud mixing ratio profiles
...
basedir3 = '/rigel/home/scs2229/top-secret/MCS_clim/ausgabe/meteo_clim/qc/core/'
basedir4 = '/rigel/home/scs2229/top-secret/MCS_clim/ausgabe/meteo_clim/pressure/'

T1 = np.load(basedir + 'T_ENDJF1.npy')    # El Nino, least deep
T2 = np.load(basedir + 'T_LNDJF1.npy')    # La Nina, least deep

qv1 = np.load(basedir2 + 'qv_ENDJF1.npy')
qv2 = np.load(basedir2 + 'qv_LNDJF1.npy')

qc1 = np.load(basedir3 + 'qc_ENDJF1.npy')
qc2 = np.load(basedir3 + 'qc_LNDJF1.npy')

print qc1.shape,qv1.shape,T1.shape
print qc2.shape,qv2.shape,T2.shape
...
#np.save('/rigel/home/scs2229/top-secret/MCS_clim/scripts/figs/dragEN.npy',pfd1)
#np.save('/rigel/home/scs2229/top-secret/MCS_clim/scripts/figs/dragLN.npy',pfd2)
#np.save('/rigel/home/scs2229/top-secret/MCS_clim/scripts/figs/buoyEN.npy',B1)
#np.save('/rigel/home/scs2229/top-secret/MCS_clim/scripts/figs/buoyLN.npy',B2)
#sys.exit()
...
ax4.plot(np.transpose(pfd1[:200:]),press,linewidth=0.5)
ax4.plot(np.nanmean(pfd1,axis=0),press,linewidth=1.25,color='k')
ax4.plot([0,0],[y1,y2],color='k',linestyle='--',linewidth=0.75)
plt.ylim([y1,y2])
ax4.set_xlim([-1,2])
...
ax5.plot(np.transpose(pfd2[:200:]),press,linewidth=0.5)
ax5.plot(np.nanmean(pfd2,axis=0),press,color='k',linewidth=1.25)
ax5.plot([0,0],[y1,y2],color='k',linestyle='--',linewidth=0.75)
plt.ylim([y1,y2])
ax5.set_xlim([-1,2])
...
ax6.plot((np.nanmean(pfd1,axis=0)-np.nanmean(pfd2,axis=0))/np.nanmean(pfd2,axis=0)*100.,\
    press,linewidth=1.25,color='k')
ax6.plot([0,0],[y1,y2],color='k',linestyle='--',linewidth=0.75)
...
fig.savefig('/rigel/home/scs2229/top-secret/MCS_clim/ausgabe/meteo_clim/dragBuoyd1.pdf',bbox_inches='tight')
plt.show()
